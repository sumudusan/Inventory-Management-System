...
namespace FinalProject.DAL
{
    internal class transactionDetailDAL
    {
        ...
        #region Insert Method transaction Details
        ...
        public bool InsertTransactionDetail(transactionDetailBLL td)
        {
            ...
            try
            {
                String sql = "INSERT INTO tbl_tansaction_detail (product_id, rate, qty, total, dea_cust_id, added_date, added_by) VALUES (@product_id, @rate, @qty, @total, @dea_cust_id, @added_date, @added_by)";
